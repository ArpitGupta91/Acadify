...
def _detect_subject(query: str, subjects: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    alias_map = {
        ...
        "cs205b": ["ai and its applications", "artificial intelligence and its applications", "cs205b"],
        ...
        "cs307e": ["elective", "intelligent systems", "intelligent system", "text and vision", "vision api", "cs307e"],
